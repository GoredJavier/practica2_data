...
```
5. Se muestra la información del título:
...
6. Se muestra la tabla resumen con los datos según indicado en el ejercicio y con la libreria DT; cabe destacar que el dataframe de trabajo contiene información adicional.
